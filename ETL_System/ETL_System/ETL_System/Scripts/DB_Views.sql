...
SELECT
	...
	,CASE WHEN j.job_type_id = 1 THEN convert(varchar(25),n.next_execution,121) ELSE cast('Checkpoint' as varchar(25)) END as [Next Execution]
	...
	,li.start_timestamp as [Last Executed]
	,DATEDIFF(second,li.end_timestamp,li.start_timestamp) [Last Duration]
