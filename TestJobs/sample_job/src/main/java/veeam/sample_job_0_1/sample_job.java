...
public String getJob_schedule_type(){
	...
	private final String projectName = "VEEAM";
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tMSSqlConnection_1";
        ...
        new BytesLimit65535_tMSSqlConnection_1().limitLog4jByte();
		    ...
		    String url_tMSSqlConnection_1 = "jdbc:sqlserver://" + "BUH0522\\SQLEXPRESS" ;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_VEEAM_sample_job = new byte[0];
    static byte[] commonByteArray_VEEAM_sample_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VEEAM_sample_job.length) {
				if(length < 1024 && commonByteArray_VEEAM_sample_job.length == 0) {
   					commonByteArray_VEEAM_sample_job = new byte[1024];
				} else {
   					commonByteArray_VEEAM_sample_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VEEAM_sample_job, 0, length);
			strReturn = new String(commonByteArray_VEEAM_sample_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VEEAM_sample_job) {
 ...
 */
	...
	currentComponent="tMSSqlInput_1";
        ...
        new BytesLimit65535_tMSSqlInput_1().limitLog4jByte();
		    ...
		    String dbquery_tMSSqlInput_1 = "select job_name,data_checkpoint,time_checkpoint from tstsz.dbo.jobs_list where job_name = '" + context.target_job +"';";
...
row2.data_checkpoint = row3.data_checkpoint + 177;
row2.time_checkpoint = row3.time_checkpoint;
context.this_checkpoint = Long.toString(row2.data_checkpoint);
System.out.println("UPDATE tstsz.dbo.jobs_list SET data_checkpoint = " + context.this_checkpoint);	
    nb_line_tJavaRow_1++;   
...
query_tMSSqlRow_1 = "UPDATE tstsz.dbo.jobs_list SET data_checkpoint = " + context.this_checkpoint + " where job_name = '" + context.target_job +"';";
 ...
 */
	...
	System.err.println("job success");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "job success");
	globalMap.put("tDie_1_DIE_MESSAGES", "job success");
	currentComponent = "tDie_1";
	status = "failure";
        errorCode = new Integer(context.this_checkpoint);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sample_job.class.getClassLoader().getResourceAsStream("veeam/sample_job_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     76560 characters generated by Talend Open Studio for Big Data 
 *     on the 07 martie 2018 01:00:13 EET
 ************************************************************************************************/