...
package local_project.stage_user_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_stage_user = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_stage_user = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_stage_user.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_stage_user.length == 0) {
   					commonByteArray_LOCAL_PROJECT_stage_user = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_stage_user = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_stage_user, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_stage_user, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_stage_user) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stage_user.class.getClassLoader().getResourceAsStream("local_project/stage_user_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     75888 characters generated by Talend Open Studio for Big Data 
 *     on the March 27, 2018 12:31:46 AM EEST
 ************************************************************************************************/