...
/**
 * Job: stage_user Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.3.0.20161026_1219
 * @status 
 */
public class stage_user implements TalendJob {
...
public String getJob_schedule_type(){
	...
	private final String jobName = "stage_user";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(stage_user.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_VEEAM_stage_user = new byte[0];
    static byte[] commonByteArray_VEEAM_stage_user = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VEEAM_stage_user.length) {
				if(length < 1024 && commonByteArray_VEEAM_stage_user.length == 0) {
   					commonByteArray_VEEAM_stage_user = new byte[1024];
				} else {
   					commonByteArray_VEEAM_stage_user = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VEEAM_stage_user, 0, length);
			strReturn = new String(commonByteArray_VEEAM_stage_user, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VEEAM_stage_user) {
 ...
 */
    ...
    public static void main(String[] args){
        final stage_user stage_userClass = new stage_user();

        int exitCode = stage_userClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stage_user.class.getClassLoader().getResourceAsStream("veeam/stage_user_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : stage_user");
        }
...
/************************************************************************************************
 *     73754 characters generated by Talend Open Studio for Big Data 
 *     on the 11 martie 2018 18:16:50 EET
 ************************************************************************************************/