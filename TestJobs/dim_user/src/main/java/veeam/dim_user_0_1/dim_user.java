...
/**
 * Job: dim_user Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.3.0.20161026_1219
 * @status 
 */
public class dim_user implements TalendJob {
...
public String getJob_schedule_type(){
	...
	private final String jobName = "dim_user";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_user.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_VEEAM_dim_user = new byte[0];
    static byte[] commonByteArray_VEEAM_dim_user = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VEEAM_dim_user.length) {
				if(length < 1024 && commonByteArray_VEEAM_dim_user.length == 0) {
   					commonByteArray_VEEAM_dim_user = new byte[1024];
				} else {
   					commonByteArray_VEEAM_dim_user = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VEEAM_dim_user, 0, length);
			strReturn = new String(commonByteArray_VEEAM_dim_user, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VEEAM_dim_user) {
 ...
 */
    ...
    public static void main(String[] args){
        final dim_user dim_userClass = new dim_user();

        int exitCode = dim_userClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_user.class.getClassLoader().getResourceAsStream("veeam/dim_user_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_user");
        }
...
/************************************************************************************************
 *     73656 characters generated by Talend Open Studio for Big Data 
 *     on the 11 martie 2018 18:16:00 EET
 ************************************************************************************************/