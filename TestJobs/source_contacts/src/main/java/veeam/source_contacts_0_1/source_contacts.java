...
package veeam.source_contacts_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_VEEAM_source_contacts = new byte[0];
    static byte[] commonByteArray_VEEAM_source_contacts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VEEAM_source_contacts.length) {
				if(length < 1024 && commonByteArray_VEEAM_source_contacts.length == 0) {
   					commonByteArray_VEEAM_source_contacts = new byte[1024];
				} else {
   					commonByteArray_VEEAM_source_contacts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VEEAM_source_contacts, 0, length);
			strReturn = new String(commonByteArray_VEEAM_source_contacts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VEEAM_source_contacts) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = source_contacts.class.getClassLoader().getResourceAsStream("veeam/source_contacts_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     73999 characters generated by Talend Open Studio for Big Data 
 *     on the 11 martie 2018 18:16:26 EET
 ************************************************************************************************/